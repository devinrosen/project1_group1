...
We then pivoted to compare The HPI to the he Real Estate Select Sector SPDR Fund (XLRE). The XLRE fund is a fund that was created towards the end 0f 2015 with their first quarterly report being 10/1/2015. This fund is a cumulation of securities of companies in the real estate industy, real estate management and development compnaies and REIT's. For this comparison we re-sliced the HPI data to also start with first data entry being that of 10/01/2015. Once we had our time and frequency variables in equilabrium we focused on the closing data for all three dataframes then calculated and plotted the returns in 3 seperate plots. The first one being quartertly returns of HPI & S&P 500 since 1985. The second plot containts quarterly returns for HPI & XLRE since 10/01/2015. The very last plot is all 3 data sets against eachother, again from 10/01/2015, to keep the variables even. 
...
#### Analysis Results
* Residential Residental Real Esate is by far the most stable and consistnent of the 3 asset classes, indicating less price swings and less uncertantity in the future value of your asset. 
* S&P 500 is extremetly voliatle when compared to The HPI and actual physical residental real estate. Even in the housing market crash of 2007 the negative returns were miniscule (about a 10% drop from 2005-2010) as compared to the S&P 500 crash from 2007-2009, resulting in a loss of value of around 20%. 
...
* Minus the real estate crash of 2007 and the mortgage crisis of 2021-2022, there is almost major price swing of Real Estate going back to 1985 and in fact usually has very small price increases/decreases per year, which on the graph looks stagnat, this is due to the fact that the price residental real estate is 1000x the price of a single share of any given stock so increase are very small in percentage terms and also the fact the real estate generally does not lose lot of value, which makes it a very logical and safe investment. 
* The HPI has a very weak, and slight negative, correlation with the XLRE. The correlation is a little stronger, though still negative with the S&P500. This means that residental real estate as very little if at all any correlation with the securities market, even real estate securities, and that prices don't always move in the right direction with the other two, because even if the stock market has a decline the residental real estate in America, generally, still holds it's value. 
* The opposite is true for the S&P and XLRE as it hold a very strong, positive correlation. Meaning prices tend to move together in the same direction, as also show on the comparitative return plot of the 3 assets. 
* While all 3 asset classes have Sharpe Ratios over 1, and therefore generally acceptable, the impressive 18.807 sharpe ratio of The HPI blows the other two out of the water, making, easily, residental housing the most sound return on your invetment 

## c. Using Monte Carlo Simulations and Plot Distributions on HPI, XLRE & The S&P 500.
After conducting our investment return analysis on The HPI, XLRE & S&P 500, we took it a step furthur and ran a Monte Carlo Analysis on the respective asset classes. To perform the analysis we used the closing dates starting from 10-01-2015 for all 3 assets and conducted 3 seperate scenarios for each asset individually, using 500 simulations for each scenario. We then plotted the simulation results and the distribution probalities. 
...
#### Analysis Results
* Due to the volatile nature of the securties market you can see that both the S&P 500 has the biggest variations in outcomes, with  multiple outlier scenarios over 200% returns. Although due to the nature of the stock market as well, this simulation shows that The S&P 500 offers, by far, the largest return on invesment in terms of percentages. 
* The distribution plot shows that a 95%CI of returns fall within of 0-80% retuns over 30 years, with the majority of the 500 simulations ran ended with 0-50% return on your investment over 30 years. 
* The XLRE Fund also has noticable variations in outcomes due to the volatitily of the securities market, even though the securtities and equites all involve real estate. Although due to this asset class not being diversified. the returns are minimized with the largest outlier having a return of only 30% in 30 years, compared to the 400% of the diversifed index. 
* The XLRE Distribuiton plot agin is very left slanted, like the S&P 500, with 95%CI of the 500 simulations falling within the first quartile of 0-8% returns, the majority of which were within 0-3% returns on investment.
* The HPI simulation scenario being the most safe choice, with all 500 scenarios having at least a 5% return over 30 years. 
* The HPI scenario also seems to be the most consistnent, having the least amount of outliers, with only 1 scenario that was noticable via a line plot. 
* The distribution plot of The HPI is the standard bell-curve plot with a 95%CI falling within arounf 7-14.5% return of investment, the majority of which are in the middle - around 10% return. 


### Investment Conclusion
After running our invesment analysis, the revelation seems to be that residental real estate is a very safe and secure investment, which some would argue is the best investment on Earth. This is a result of extremely low price swings, in either direction, leading to a slow and steady climb in prices that can lead to denerating wealth for one's self. This is shown in the astoshing 18 point sharpe ration and our Monte Carlo simulation showing 0 out of the 500 simulations losing money over a 30 year horizon, as compared with the XLRE & S&P500 simulations that had multiple scenarios losing money or no making any returns over the same 30 year horizon. 

As an investor, one should absloutely include residental homes into their total investment portfolio to, not only maximize, their returns and wealth, but also help stabalize the portfolio by diversifying into residential real estate and combating the negative returns that can happen in the sceurities market, as shown in our investment correlation analysis.